...
struct LockBudgetWidgetProvider: IntentTimelineProvider {
    ...
    func getSnapshot(for configuration: BudgetWidgetConfigurationIntent, in context: Context, completion: @escaping (LockBudgetWidgetEntry) -> ()) {
    ...
    func getTimeline(for configuration: BudgetWidgetConfigurationIntent, in context: Context, completion: @escaping (Timeline<Entry>) -> ()) {
