                                ...
                                Button {
                                    ...
                                    HStack(spacing: 3) {
                                        ...
                                        Text("\(currencySymbol)\(Int(round(transaction.wrappedAmount)))")
                                            ...
                                            .background(Color(hex: transaction.wrappedColour).opacity(0.23), in: RoundedRectangle(cornerRadius: 6.5, style: .continuous))
                                    }
                                    .padding(5)
...
//                                            .font(.system(size: 17.5, weight: .semibold, design: .rounded))
                                    ...
                                    .background(Color(hex: unwrappedCategory.wrappedColour).opacity(0.35), in: RoundedRectangle(cornerRadius: 11.5, style: .continuous))
...
//            }
    ...
    init(category: Binding<Category?>?, showPicker: Binding<Bool>, showSheet: Binding<Bool>, income: Bool, darkMode: Bool) {
        ...
        self.initialCategory = category?.wrappedValue
                ...
                VStack {
                    Button {
                        ...
                        Image(systemName: "chevron.up")
                            ...
                            .foregroundColor(Color.SubtitleText)
                            .padding(7)
                            .background(Color.SecondaryBackground, in: RoundedRectangle(cornerRadius: 6, style: .continuous))
                            .contentShape(Circle())
